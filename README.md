...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,805 | 🐛 119 | 🌐 Rust | 📅 2026-09-11

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,805 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,805 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,805 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Smaller examples included in official repo.
...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 21,040 | 🐛 906 | 🌐 Rust | 📅 2026-09-14 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,882 | 🐛 187 | 🌐 Rust | 📅 2026-09-15 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,247 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,787 | 🐛 74 | 🌐 Rust | 📅 2026-09-11 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,062 | 🐛 2 | 🌐 Rust | 📅 2026-09-13 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 990 | 🐛 147 | 🌐 Rust | 📅 2026-09-09 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
...
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 394 | 🐛 93 | 🌐 Rust | 📅 2026-09-15 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-15 - The Frontend of Everything.
...
* [yew-duskmoon-ui](https://github.com/gsmlg-dev/yew-duskmoon-ui) ⭐ 6 | 🐛 3 | 🌐 Rust | 📅 2026-09-14 - Duskmoon UI Component Library. This package use `stylist` to embbed css in components, so no extra CSS file is needed. [Live Demo](https://gsmlg-dev.github.io/yew-duskmoon-ui/).
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,008 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,972 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-06.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 100 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,486 | 🐛 26 | 🌐 TypeScript | 📅 2026-09-08 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,453 | 🐛 17 | 🌐 Rust | 📅 2026-09-14 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,149 | 🐛 562 | 🌐 Rust | 📅 2026-09-15 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 111,085 | 🐛 1,464 | 🌐 Rust | 📅 2026-09-15 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,625 | 🐛 563 | 🌐 WebAssembly | 📅 2026-09-15 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,131 | 🐛 235 | 🌐 C++ | 📅 2026-09-15 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,284 | 🐛 394 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 39,146 | 🐛 779 | 🌐 Rust | 📅 2026-09-13 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,286 | 🐛 121 | 🌐 Rust | 📅 2026-09-14 - Build fast web applications with Rust.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,356 | 🐛 11 | 🌐 Rust | 📅 2026-09-15 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,639 | 🐛 99 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
