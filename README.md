...
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,777 | 🐛 73 | 🌐 Rust | 📅 2026-08-16 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,047 | 🐛 2 | 🌐 Rust | 📅 2026-08-14 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 182 | 🐛 63 | 🌐 Rust | 📅 2026-08-18 - Secure firmware framework focusing on developer experience.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 1 | 🌐 Rust | 📅 2026-08-18 - The Frontend of Everything.
...
* [Oxfeed](https://github.com/sanpii/oxfeed) ⭐ 16 | 🐛 4 | 🌐 Rust | 📅 2026-08-14 - A feed reader written in Rust with a Yew frontend.
...
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,509 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-02 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,118 | 🐛 562 | 🌐 Rust | 📅 2026-08-18 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,331 | 🐛 1,432 | 🌐 Rust | 📅 2026-08-17 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
...
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,102 | 🐛 228 | 🌐 C++ | 📅 2026-08-18 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 38,796 | 🐛 733 | 🌐 Rust | 📅 2026-08-14 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,212 | 🐛 126 | 🌐 Rust | 📅 2026-08-17 - Build fast web applications with Rust.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,888 | 🐛 7 | 🌐 Rust | 📅 2026-08-18 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,619 | 🐛 89 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
