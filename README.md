...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,799 | 🐛 119 | 🌐 Rust | 📅 2026-09-11

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,799 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,799 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,799 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Smaller examples included in official repo.
...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 21,026 | 🐛 901 | 🌐 Rust | 📅 2026-09-11 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,862 | 🐛 186 | 🌐 Rust | 📅 2026-09-12 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,248 | 🐛 0 | 🌐 Rust | 📅 2026-09-10 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,786 | 🐛 74 | 🌐 Rust | 📅 2026-09-11 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,060 | 🐛 8 | 🌐 Rust | 📅 2026-09-12 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 989 | 🐛 146 | 🌐 Rust | 📅 2026-09-09 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 884 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 111,027 | 🐛 1,462 | 🌐 Rust | 📅 2026-09-12.
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 394 | 🐛 91 | 🌐 Rust | 📅 2026-09-12 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Taxy](https://github.com/picoHz/taxy/tree/main) ⭐ 203 | 🐛 5 | 🌐 Rust | 📅 2025-04-06 - A reverse proxy server with built-in WebUI, supporting TCP/HTTP/TLS/WebSocket, written in Rust.
* [Crabtyper](https://github.com/brancobruyneel/crabtyper) ⭐ 188 | 🐛 9 | 🌐 Rust | 📅 2022-08-25 - A speedtyping web app written in Rust.
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 188 | 🐛 62 | 🌐 Rust | 📅 2026-09-10 - Secure firmware framework focusing on developer experience.
* [caniuse.rs](https://github.com/jplatte/caniuse.rs) ⚠️ Archived - Rust feature search.
* [Kiomet](https://github.com/SoftbearStudios/kiomet) ⭐ 177 | 🐛 6 | 🌐 Rust | 📅 2025-09-10 - An online real-time strategy game in which you expand your territory by capturing towers.
...
* [Syre](https://github.com/syre-data/syre) ⭐ 102 | 🐛 3 | 🌐 Rust | 📅 2026-09-12 - Scientific data management and insights.
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 73 | 🐛 10 | 🌐 Rust | 📅 2026-09-11 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-12 - The Frontend of Everything.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,011 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,972 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-06.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,486 | 🐛 25 | 🌐 TypeScript | 📅 2026-09-08 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [yew-side-effect](https://github.com/futursolo/yew-side-effect) ⚠️ Archived - Reconcile Side Effects in Yew Applications, inspired by [react-side-effect](https://github.com/gaearon/react-side-effect) ⭐ 1,213 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-04 and [react-helmet](https://github.com/nfl/react-helmet) ⭐ 17,454 | 🐛 219 | 🌐 JavaScript | 📅 2023-07-18.

### Javascript Library Ports

* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,451 | 🐛 15 | 🌐 Rust | 📅 2026-09-12 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,148 | 🐛 561 | 🌐 Rust | 📅 2026-09-12 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [tauri-sys](https://github.com/JonasKruckenberg/tauri-sys) ⭐ 124 | 🐛 24 | 🌐 Rust | 📅 2026-09-11 - Raw bindings to the Tauri API for projects using wasm-bindgen.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 111,027 | 🐛 1,462 | 🌐 Rust | 📅 2026-09-12 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 569 | 🌐 WebAssembly | 📅 2026-09-12 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,126 | 🐛 241 | 🌐 C++ | 📅 2026-09-06 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,284 | 🐛 393 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,390 | 🐛 136 | 🌐 Rust | 📅 2026-09-09 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 39,060 | 🐛 774 | 🌐 Rust | 📅 2026-09-12 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,282 | 🐛 118 | 🌐 Rust | 📅 2026-09-11 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,836 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,351 | 🐛 34 | 🌐 Rust | 📅 2026-08-31 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,319 | 🐛 10 | 🌐 Rust | 📅 2026-09-12 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,638 | 🐛 99 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
