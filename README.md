...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 20,896 | 🐛 919 | 🌐 Rust | 📅 2026-08-06 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,504 | 🐛 162 | 🌐 Rust | 📅 2026-08-12 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,245 | 🐛 1 | 🌐 Rust | 📅 2026-08-13 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,776 | 🐛 75 | 🌐 Rust | 📅 2026-08-11 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,043 | 🐛 4 | 🌐 Rust | 📅 2026-08-07 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 182 | 🐛 64 | 🌐 Rust | 📅 2026-08-11 - Secure firmware framework focusing on developer experience.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 0 | 🌐 Rust | 📅 2026-08-12 - The Frontend of Everything.
...
* [yew-duskmoon-ui](https://github.com/gsmlg-dev/yew-duskmoon-ui) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-07-17 - Duskmoon UI Component Library. This package use `stylist` to embbed css in components, so no extra CSS file is needed. [Live Demo](https://gsmlg-dev.github.io/yew-duskmoon-ui/).
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,012 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,976 | 🐛 145 | 🌐 TypeScript | 📅 2026-08-09.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,517 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-02 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,118 | 🐛 560 | 🌐 Rust | 📅 2026-08-12 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,163 | 🐛 1,434 | 🌐 Rust | 📅 2026-08-13 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,596 | 🐛 560 | 🌐 WebAssembly | 📅 2026-08-13 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,098 | 🐛 230 | 🌐 C++ | 📅 2026-08-12 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,274 | 🐛 392 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 38,637 | 🐛 734 | 🌐 Rust | 📅 2026-08-10 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,201 | 🐛 125 | 🌐 Rust | 📅 2026-08-08 - Build fast web applications with Rust.
