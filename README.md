...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,803 | 🐛 119 | 🌐 Rust | 📅 2026-09-11

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,803 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,803 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,803 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Smaller examples included in official repo.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,060 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 73 | 🐛 11 | 🌐 Rust | 📅 2026-09-13 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 5 | 🌐 TypeScript | 📅 2026-09-13 - The Frontend of Everything.
...
* [yew-duskmoon-ui](https://github.com/gsmlg-dev/yew-duskmoon-ui) ⭐ 6 | 🐛 2 | 🌐 Rust | 📅 2026-09-04 - Duskmoon UI Component Library. This package use `stylist` to embbed css in components, so no extra CSS file is needed. [Live Demo](https://gsmlg-dev.github.io/yew-duskmoon-ui/).
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,010 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,972 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-06.
...
* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,453 | 🐛 16 | 🌐 Rust | 📅 2026-09-12 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 111,040 | 🐛 1,463 | 🌐 Rust | 📅 2026-09-13 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,623 | 🐛 569 | 🌐 WebAssembly | 📅 2026-09-12 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,127 | 🐛 242 | 🌐 C++ | 📅 2026-09-06 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,284 | 🐛 393 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,391 | 🐛 136 | 🌐 Rust | 📅 2026-09-09 - Build, bundle & ship your Rust Wasm application to the web.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 39,095 | 🐛 777 | 🌐 Rust | 📅 2026-09-13 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,282 | 🐛 120 | 🌐 Rust | 📅 2026-09-13 - Build fast web applications with Rust.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,332 | 🐛 10 | 🌐 Rust | 📅 2026-09-13 - A curated list of Rust code and resources.
