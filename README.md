...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,806 | 🐛 119 | 🌐 Rust | 📅 2026-09-11

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,806 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,806 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,806 | 🐛 119 | 🌐 Rust | 📅 2026-09-11 - Smaller examples included in official repo.
...
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,874 | 🐛 182 | 🌐 Rust | 📅 2026-09-14 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,061 | 🐛 1 | 🌐 Rust | 📅 2026-09-13 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 1 | 🌐 TypeScript | 📅 2026-09-14 - The Frontend of Everything.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,009 | 🐛 664 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,973 | 🐛 129 | 🌐 TypeScript | 📅 2026-09-06.
...
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,624 | 🐛 564 | 🌐 WebAssembly | 📅 2026-09-14 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,129 | 🐛 237 | 🌐 C++ | 📅 2026-09-14 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 39,131 | 🐛 778 | 🌐 Rust | 📅 2026-09-13 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,285 | 🐛 121 | 🌐 Rust | 📅 2026-09-14 - Build fast web applications with Rust.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,341 | 🐛 12 | 🌐 Rust | 📅 2026-09-14 - A curated list of Rust code and resources.
