...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,786 | 🐛 114 | 🌐 Rust | 📅 2026-08-26

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,786 | 🐛 114 | 🌐 Rust | 📅 2026-08-26 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,786 | 🐛 114 | 🌐 Rust | 📅 2026-08-26 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,786 | 🐛 114 | 🌐 Rust | 📅 2026-08-26 - Smaller examples included in official repo.
...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 20,955 | 🐛 888 | 🌐 Rust | 📅 2026-08-23 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,545 | 🐛 177 | 🌐 Rust | 📅 2026-08-26 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,246 | 🐛 0 | 🌐 Rust | 📅 2026-08-20 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,784 | 🐛 73 | 🌐 Rust | 📅 2026-08-16 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,050 | 🐛 7 | 🌐 Rust | 📅 2026-08-21 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 969 | 🐛 148 | 🌐 Rust | 📅 2026-08-10 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 885 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,586 | 🐛 1,444 | 🌐 Rust | 📅 2026-08-26.
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 393 | 🐛 94 | 🌐 Rust | 📅 2026-08-26 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 184 | 🐛 63 | 🌐 Rust | 📅 2026-08-23 - Secure firmware framework focusing on developer experience.
...
* [diff.rs](https://github.com/xfbs/diff.rs) ⭐ 138 | 🐛 43 | 🌐 Rust | 📅 2026-04-23 - Web application to render a diff between Rust crate versions. Implemented in Yew, runs fully in the browser as WebAssembly, [Live Demo](https://diff.rs).
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 2 | 🌐 Rust | 📅 2026-08-26 - The Frontend of Everything.
...
* [patternfly-yew](https://github.com/ctron/patternfly-yew) ⭐ 165 | 🐛 24 | 🌐 Rust | 📅 2026-06-19 - Patternfly components for Yew.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,024 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,982 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-09.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,509 | 🐛 49 | 🌐 TypeScript | 📅 2026-08-20 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,451 | 🐛 13 | 🌐 Rust | 📅 2026-08-03 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [popper-rs](https://github.com/ctron/popper-rs/) ⭐ 5 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-30 - [Popper JS](https://popper.js.org/) bindings for Rust.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,126 | 🐛 570 | 🌐 Rust | 📅 2026-08-26 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,586 | 🐛 1,444 | 🌐 Rust | 📅 2026-08-26 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,611 | 🐛 559 | 🌐 WebAssembly | 📅 2026-08-26 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,105 | 🐛 228 | 🌐 C++ | 📅 2026-08-26 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,282 | 🐛 392 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,376 | 🐛 135 | 🌐 Rust | 📅 2026-08-26 - Build, bundle & ship your Rust Wasm application to the web.
...
* [yew-fmt](https://github.com/schvv31n/yew-fmt) ⭐ 28 | 🐛 2 | 🌐 Rust | 📅 2025-07-16 - A configurable extension to `rustfmt` for formatting Yew HTML.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 38,893 | 🐛 746 | 🌐 Rust | 📅 2026-08-26 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,244 | 🐛 128 | 🌐 Rust | 📅 2026-08-24 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,836 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,344 | 🐛 34 | 🌐 Rust | 📅 2026-08-22 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 58,982 | 🐛 7 | 🌐 Rust | 📅 2026-08-24 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,631 | 🐛 94 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
