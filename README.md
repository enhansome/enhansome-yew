...
[<img src="logo.svg" align="right" width="100" title="Awesome Yew">](https://github.com/yewstack/yew) ⭐ 32,790 | 🐛 114 | 🌐 Rust | 📅 2026-09-01

> A curated list of awesome things related to Yew.

[Yew](https://github.com/yewstack/yew) ⭐ 32,790 | 🐛 114 | 🌐 Rust | 📅 2026-09-01 is a modern Rust framework inspired by Elm and React for creating multi-threaded frontend apps with WebAssembly.
...
* [Yew](https://github.com/yewstack/yew) ⭐ 32,790 | 🐛 114 | 🌐 Rust | 📅 2026-09-01 - Rust / WebAssembly framework for building client web apps.
* [Examples](https://github.com/yewstack/yew/tree/master/examples) ⭐ 32,790 | 🐛 114 | 🌐 Rust | 📅 2026-09-01 - Smaller examples included in official repo.
...
* [candle-wasm-examples](https://github.com/huggingface/candle) ⭐ 20,983 | 🐛 898 | 🌐 Rust | 📅 2026-09-01 - Candle is a minimalist ML framework for Rust with a focus on performance (including GPU support) and ease of use. Try our online demos: [whisper](https://huggingface.co/spaces/lmz/candle-whisper), [LLaMA2](https://huggingface.co/spaces/lmz/candle-llama2), [T5](https://huggingface.co/spaces/radames/Candle-T5-Generation-Wasm), [yolo](https://huggingface.co/spaces/lmz/candle-yolo), [Segment
  Anything](https://huggingface.co/spaces/radames/candle-segment-anything-wasm).
* [Apache Iggy](https://github.com/apache/iggy) ⭐ 4,733 | 🐛 174 | 🌐 Rust | 📅 2026-09-01 - Apache Iggy: Hyper-Efficient Message Streaming at Laser Speed.
* [webapp.rs](https://github.com/saschagrunert/webapp.rs) ⭐ 2,248 | 🐛 0 | 🌐 Rust | 📅 2026-08-27 - A web application completely written in Rust, frontend is built with Yew.
* [zoom-rs](https://github.com/security-union/zoom-rs) ⭐ 1,785 | 🐛 73 | 🌐 Rust | 📅 2026-09-01 - Zoom clone written in rust for research purposes.
...
* [Proxelar](https://github.com/emanuele-em/proxelar) ⭐ 1,051 | 🐛 7 | 🌐 Rust | 📅 2026-08-28 - Rust-based Man in the Middle proxy, an early-stage project aimed at providing visibility into network traffic.
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 972 | 🐛 150 | 🌐 Rust | 📅 2026-08-10 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 885 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,732 | 🐛 1,457 | 🌐 Rust | 📅 2026-09-01.
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 394 | 🐛 87 | 🌐 Rust | 📅 2026-09-01 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Taxy](https://github.com/picoHz/taxy/tree/main) ⭐ 201 | 🐛 5 | 🌐 Rust | 📅 2025-04-06 - A reverse proxy server with built-in WebUI, supporting TCP/HTTP/TLS/WebSocket, written in Rust.
...
* [Google Wasefire](https://github.com/google/wasefire) ⭐ 185 | 🐛 66 | 🌐 Rust | 📅 2026-09-01 - Secure firmware framework focusing on developer experience.
* [Kiomet](https://github.com/SoftbearStudios/kiomet) ⭐ 175 | 🐛 6 | 🌐 Rust | 📅 2025-09-10 - An online real-time strategy game in which you expand your territory by capturing towers.
...
* [diff.rs](https://github.com/xfbs/diff.rs) ⭐ 138 | 🐛 44 | 🌐 Rust | 📅 2026-04-23 - Web application to render a diff between Rust crate versions. Implemented in Yew, runs fully in the browser as WebAssembly, [Live Demo](https://diff.rs).
* [chipbox](https://github.com/chipnertkj/chipbox) ⭐ 137 | 🐛 13 | 🌐 Rust | 📅 2026-04-24 - chipbox is an open-source desktop DAW written in Rust.
* [Rust algorithms](https://github.com/Jondolf/rust-algorithms) ⭐ 129 | 🐛 1 | 🌐 Rust | 📅 2024-07-17 - A website with interactive implementations of various algorithms.
* [Yew-WebRTC-Chat](https://github.com/codec-abc/Yew-WebRTC-Chat) ⭐ 127 | 🐛 2 | 🌐 Rust | 📅 2023-08-17 - A simple WebRTC chat made with Yew.
* [CubeShuffle](https://github.com/philipborg/CubeShuffle) ⭐ 108 | 🐛 29 | 🌐 Rust | 📅 2026-08-15 - Card game shuffling utility built with Rust, Yew, Bulma and Tauri.
* [web-view todomvc desktop app](https://github.com/Extrawurst/rust-webview-todomvc-yew) ⭐ 107 | 🐛 15 | 🌐 Rust | 📅 2023-01-20 - Demo how to use yew for a todomvc that compiles to WebAssembly and is bundled as a lightweight(\~2mb) desktop app by [web-view](https://github.com/Boscop/web-view) ⭐ 1,952 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09, as an alternative to Electron, [web-view](https://github.com/Boscop/web-view) ⭐ 1,952 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09 also has a [demo](https://github.com/Boscop/web-view/tree/master/examples#todo-yew) ⭐ 1,952 | 🐛 117 | 🌐 JavaScript | 📅 2024-05-09.
...
* [Syre](https://github.com/syre-data/syre) ⭐ 102 | 🐛 3 | 🌐 Rust | 📅 2026-05-08 - Scientific data management and insights.
...
* [simply-view-image-for-python-debugging](https://github.com/elazarcoh/simply-view-image-for-python-debugging?tab=readme-ov-file) ⭐ 73 | 🐛 10 | 🌐 Rust | 📅 2026-09-01 - Visual studio code extension simply view the image of the image variables when debugging python.
...
* [Rust Audio](https://github.com/austintheriot/audio) ⭐ 56 | 🐛 2 | 🌐 Rust | 📅 2026-04-23 - Realtime audio processing / synthesis using Rust/WASM in the browser, [Live Demo](https://austintheriot.github.io/audio/).
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 4 | 🌐 Rust | 📅 2026-09-01 - The Frontend of Everything.
...
* [Oxfeed](https://github.com/sanpii/oxfeed) ⭐ 16 | 🐛 5 | 🌐 Rust | 📅 2026-08-14 - A feed reader written in Rust with a Yew frontend.
...
* [0721](https://github.com/langyo/0721) ⭐ 12 | 🐛 4 | 🌐 Rust | 📅 2026-08-01 - The engine of image hosting written in Rust.
...
* [Sea\_battle](https://github.com/MAE664128/sea_battle) ⭐ 2 | 🐛 0 | 🌐 Rust | 📅 2022-07-09 - A simple example of a sea battle game. Rust + Yew.
...
* [viz.rs](https://github.com/viz-rs/viz-rs.github.io) ⭐ 0 | 🐛 0 | 📅 2026-05-29 - A website for viz web framework, [Live Demo](https://viz.rs/).
...
* [patternfly-yew](https://github.com/ctron/patternfly-yew) ⭐ 165 | 🐛 24 | 🌐 Rust | 📅 2026-08-31 - Patternfly components for Yew.
...
* [yew-bootstrap](https://github.com/isosphere/yew-bootstrap) ⭐ 45 | 🐛 11 | 🌐 Rust | 📅 2026-02-08 - A Yew wrapper for the Bootstrap 5 component library.
...
* [yew-nav-link](https://github.com/RAprogramm/yew-nav-link) ⭐ 13 | 🐛 4 | 🌐 Rust | 📅 2026-08-31 - A navigational link that is aware of its active state based on the current route in the application.
* [Zu](https://github.com/RustVis/zu) ⭐ 10 | 🐛 0 | 🌐 Rust | 📅 2026-06-03 - Yew web components, implementing Material Design.
* [yew-duskmoon-ui](https://github.com/gsmlg-dev/yew-duskmoon-ui) ⭐ 6 | 🐛 1 | 🌐 Rust | 📅 2026-08-25 - Duskmoon UI Component Library. This package use `stylist` to embbed css in components, so no extra CSS file is needed. [Live Demo](https://gsmlg-dev.github.io/yew-duskmoon-ui/).
...
* [Yew Form](https://github.com/jfbilodeau/yew_form) ⭐ 97 | 🐛 9 | 🌐 Rust | 📅 2022-03-23 - Components to simplify handling forms with Yew.
* [yew-oauth2](https://github.com/ctron/yew-oauth2/) ⭐ 48 | 🐛 9 | 🌐 Rust | 📅 2026-07-09 - A plain Yew OAuth2/OpenIDConnect component, not tied to any CSS framework.
* [yew-component-size](https://github.com/AircastDev/yew-component-size) ⚠️ Archived - A Yew component that emits events when the parent component changes width/height.
* [yew-virtual-scroller](https://github.com/AircastDev/yew-virtual-scroller) ⚠️ Archived - A Yew component for virtual scrolling / scroll windowing.
* [yew-scroll-area](https://github.com/MatchaChoco010/yew-scroll-area) ⭐ 4 | 🐛 2 | 🌐 Rust | 📅 2022-06-08 - Custom scroll area for Yew.

### Hooks

* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,016 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,977 | 🐛 130 | 🌐 TypeScript | 📅 2026-09-01.
* [Bounce](https://github.com/bounce-rs/bounce) ⭐ 99 | 🐛 15 | 🌐 Rust | 📅 2026-03-30 - The uncomplicated state management library for Yew, inspired by [Redux](https://github.com/reduxjs/redux) ⭐ 61,510 | 🐛 50 | 🌐 TypeScript | 📅 2026-08-20 and [Recoil](https://github.com/facebookexperimental/Recoil) ⚠️ Archived.
...
* [yew-side-effect](https://github.com/futursolo/yew-side-effect) ⚠️ Archived - Reconcile Side Effects in Yew Applications, inspired by [react-side-effect](https://github.com/gaearon/react-side-effect) ⭐ 1,215 | 🐛 15 | 🌐 JavaScript | 📅 2023-03-04 and [react-helmet](https://github.com/nfl/react-helmet) ⭐ 17,457 | 🐛 219 | 🌐 JavaScript | 📅 2023-07-18.

### Javascript Library Ports

* [Plotly.rs](https://github.com/igiagkiozis/plotly) ⭐ 1,451 | 🐛 15 | 🌐 Rust | 📅 2026-08-27 - Rust bindings for the popular [Plotly](https://plotly.com/javascript/) charting library.
...
* [turf](https://github.com/myFavShrimp/turf) ⭐ 96 | 🐛 3 | 🌐 Rust | 📅 2025-05-02 - Macro based compile-time SCSS transpilation, CSS minification, and class name uniquification toolchain inspired by CSS modules.
...
* [styled-yew](https://github.com/IcyDefiance/styled-yew) ⭐ 36 | 🐛 17 | 🌐 Rust | 📅 2023-01-07 - CSS in Rust, similar to styled-components, but for Yew.
* [yew-style-in-rs](https://github.com/MatchaChoco010/yew-style-in-rs) ⭐ 22 | 🐛 1 | 🌐 Rust | 📅 2022-06-04 - Scoped CSS in Rust for Yew.
* [yew-nested-router](https://github.com/ctron/yew-nested-router) ⭐ 9 | 🐛 3 | 🌐 Rust | 📅 2026-06-17 - A router that supported nesting, with Yew 0.20.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,135 | 🐛 561 | 🌐 Rust | 📅 2026-09-01 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [tauri-sys](https://github.com/JonasKruckenberg/tauri-sys) ⭐ 124 | 🐛 25 | 🌐 Rust | 📅 2026-07-19 - Raw bindings to the Tauri API for projects using wasm-bindgen.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,732 | 🐛 1,457 | 🌐 Rust | 📅 2026-09-01 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,616 | 🐛 560 | 🌐 WebAssembly | 📅 2026-09-01 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
* [wabt](https://github.com/WebAssembly/wabt) ⭐ 8,113 | 🐛 231 | 🌐 C++ | 📅 2026-08-30 - The WebAssembly Binary Toolkit, for the `wasm-strip` and `wasm-objdump` tools to reduce .wasm file size.
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,285 | 🐛 392 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
* [Trunk](https://github.com/thedodd/trunk) ⭐ 4,383 | 🐛 136 | 🌐 Rust | 📅 2026-08-26 - Build, bundle & ship your Rust Wasm application to the web.
* [cargo-web](https://github.com/koute/cargo-web) ⭐ 1,111 | 🐛 107 | 🌐 Rust | 📅 2023-11-29 - A Cargo subcommand for the client-side Web.
...
* [yew-fmt](https://github.com/schvv31n/yew-fmt) ⭐ 28 | 🐛 3 | 🌐 Rust | 📅 2025-07-16 - A configurable extension to `rustfmt` for formatting Yew HTML.
...
* [How to use Rust Yew](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20use%20Rust%20Yew.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to use a modal in Rust](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20use%20a%20modal%20in%20Rust.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to use routers in Rust Frontend](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20use%20routers%20in%20Rust%20Frontend.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to modulize your Rust Frontend](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20modulize%20your%20Rust%20Frontend.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to use NPM packages with Rust Frontend](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20use%20NPM%20packages%20with%20Rust%20Frontend.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to use markdown with Rust Frontend](https://github.com/steadylearner/blog/blob/master/posts/Rust/How%20to%20use%20markdown%20with%20code%20snippets%20in%20Rust%20Frontend.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [Fullstack Rust with Yew](https://github.com/steadylearner/blog/tree/master/posts/Rust/Fullstack%20Rust%20with%20Yew.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to write Full Stack Rust code](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20write%20Full%20Stack%20Rust%20code.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to render a YouTube vlog with Rust Yew fetch API](https://github.com/steadylearner/blog/blob/master/posts/Rust/How%20to%20render%20a%20YouTube%20vlog%20with%20%20Rust%20Yew%20fetch%20API.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
* [How to render blog posts with Rust Yew mounted API](https://github.com/steadylearner/blog/tree/master/posts/Rust/How%20to%20render%20blog%20posts%20with%20Rust%20Yew%20mounted%20API.md) ⭐ 4 | 🐛 0 | 📅 2021-05-19
...
* [full-stack-todo-rust-course](https://github.com/brooks-builds/full-stack-todo-rust-course) ⭐ 265 | 🐛 6 | 🌐 Rust | 📅 2024-08-26 - Full stack rust course including course for Yew.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 38,939 | 🐛 761 | 🌐 Rust | 📅 2026-09-01 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
* [Leptos](https://github.com/leptos-rs/leptos) ⭐ 21,250 | 🐛 131 | 🌐 Rust | 📅 2026-09-01 - Build fast web applications with Rust.
* [Seed](https://github.com/seed-rs/seed) ⭐ 3,836 | 🐛 55 | 🌐 Rust | 📅 2025-01-11 - A Rust framework for creating web apps.
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,345 | 🐛 34 | 🌐 Rust | 📅 2026-08-31 - A reactive library for creating web apps in Rust and WebAssembly.
...
* [Sauron](https://github.com/ivanceras/sauron) ⭐ 2,066 | 🐛 7 | 🌐 Rust | 📅 2025-01-27 - Sauron is an HTML web framework for building web-apps.
...
* [Awesome Rust](https://github.com/rust-unofficial/awesome-rust) ⭐ 59,097 | 🐛 8 | 🌐 Rust | 📅 2026-09-01 - A curated list of Rust code and resources.
* [Awesome WebAssembly](https://github.com/mbasso/awesome-wasm) ⭐ 9,634 | 🐛 96 | 📅 2024-11-15 - Collection of awesome things regarding WebAssembly ecosystem.
