...
* [PinePods](https://github.com/madeofpendletonwool/PinePods) ⭐ 967 | 🐛 147 | 🌐 Rust | 📅 2026-08-10 - PinePods is a Rust based podcast management system that manages podcasts with multi-user support and relies on a central database with clients to connect to it.
* [Realworld example](https://github.com/jetli/rust-yew-realworld-example-app) ⭐ 885 | 🐛 6 | 🌐 Rust | 📅 2026-03-16 - Exemplary real world app built with Rust + Yew + WebAssembly. It utilizes Yew's latest `function components` and `hooks`. It also supports desktop application powered by [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,532 | 🐛 1,444 | 🌐 Rust | 📅 2026-08-24.
* [Sentry Relay](https://github.com/getsentry/relay) ⭐ 393 | 🐛 96 | 🌐 Rust | 📅 2026-08-24 - The Sentry Relay is a service that pushes some functionality from the Sentry SDKs as well as the Sentry server into a proxy process.
...
* [Hikari](https://github.com/celestia-island/hikari) ⭐ 23 | 🐛 4 | 🌐 Rust | 📅 2026-08-25 - The Frontend of Everything.
...
* [yew-hooks](https://github.com/jetli/yew-hooks) ⭐ 177 | 🐛 9 | 🌐 Rust | 📅 2026-04-24 - Custom Hooks library for Yew, inspired by [streamich/react-use](https://github.com/streamich/react-use) ⭐ 44,023 | 🐛 663 | 🌐 TypeScript | 📅 2026-06-10 and [alibaba/hooks](https://github.com/alibaba/hooks) ⭐ 14,981 | 🐛 146 | 🌐 TypeScript | 📅 2026-08-09.
...
* [wasm-bindgen](https://github.com/rustwasm/wasm-bindgen) ⭐ 9,123 | 🐛 570 | 🌐 Rust | 📅 2026-08-24 - Facilitating high-level interactions between WebAssembly modules and JavaScript.
...
* [Tauri](https://github.com/tauri-apps/tauri) ⭐ 110,532 | 🐛 1,444 | 🌐 Rust | 📅 2026-08-24 - Tauri is a framework for building tiny, blazingly fast binaries for all major desktop platforms. Developers can integrate any front-end framework that compiles to HTML, JS and CSS for building their user interface. The backend of the application is a rust-sourced binary with an API that the front-end can interact with.
* [binaryen](https://github.com/WebAssembly/binaryen) ⭐ 8,609 | 🐛 560 | 🌐 WebAssembly | 📅 2026-08-24 - Compiler infrastructure and toolchain library for WebAssembly, for the `wasm-opt` tool to reduce .wasm file size.
...
* [wasm-pack](https://github.com/rustwasm/wasm-pack) ⭐ 7,279 | 🐛 392 | 🌐 Rust | 📅 2026-08-12 - Your favorite Rust -> WebAssembly workflow tool.
...
* [Dioxus](https://github.com/DioxusLabs/dioxus) ⭐ 38,867 | 🐛 741 | 🌐 Rust | 📅 2026-08-24 - Elegant React-like library for building user interfaces for desktop, web, mobile, SSR, liveview, and more.
...
* [Sycamore](https://github.com/sycamore-rs/sycamore) ⭐ 3,344 | 🐛 35 | 🌐 Rust | 📅 2026-08-22 - A reactive library for creating web apps in Rust and WebAssembly.
